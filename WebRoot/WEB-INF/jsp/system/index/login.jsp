	...
	<script type="text/javascript">
		...
		function severCheck(){
			if(check()){
				...
				var code = "qq313596790fh"+loginname+",cms,"+password+"QQ978336446fh"+",cms,"+$("#code").val();
				$.ajax({
					type: "POST",
					url: 'login_login',
	...
	function register(){
		if(rcheck()){
			...
			$.ajax({
		    	...
		    	data: {USERNAME:$("#USERNAME").val(),PASSWORD:$("#PASSWORD").val(),NAME:$("#name").val(),EMAIL:$("#EMAIL").val(),rcode:$("#rcode").val(),FKEY:$.md5('USERNAME'+nowtime+',cms,'),tm:new Date().getTime()},
				dataType:'json',
				cache: false,
				success: function(data){
					if("00" == data.result){
