...
import com.cms.plugin.websocketInstantMsg.ChatServer;
import com.cms.plugin.websocketOnline.OnlineChatServer;
...
public class startFilter extends BaseController implements Filter{
	...
	public void reductionDbBackupQuartzState(){
		try {
			Db.executeUpdateFH("update DB_TIMINGBACKUP set STATUS = '2'");
