package com.cms.controller.system.sms;
...
public class SmsController extends BaseController {
	...
	String menuUrl = "sms/list.do"; //菜单地址(权限用)
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("system/sms/fhsms_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("system/sms/fhsms_edit");
	...
	public ModelAndView goView()throws Exception{
		...
		mv.setViewName("system/sms/fhsms_view");
		mv.addObject("pd", pd);
		return mv;
	}	
