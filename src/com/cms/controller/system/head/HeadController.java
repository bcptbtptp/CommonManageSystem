package com.cms.controller.system.head;
...
import com.cms.service.system.sms.SmsManager;
import com.cms.service.system.user.UserManager;
import com.cms.service.system.userphoto.UserPhotoManager;
...
public class HeadController extends BaseController {
	...
	private SmsManager fhsmsService;
	...
	public ModelAndView saveSys() throws Exception{
		...
		Tools.writeFile(Const.EMAIL,pd.getString("SMTP")+",cms,"+pd.getString("PORT")+",cms,"+pd.getString("EMAIL")+",cms,"+pd.getString("PAW"));	//写入邮件服务器配置
		Tools.writeFile(Const.SMS1,pd.getString("SMSU1")+",cms,"+pd.getString("SMSPAW1"));	//写入短信1配置
		Tools.writeFile(Const.SMS2,pd.getString("SMSU2")+",cms,"+pd.getString("SMSPAW2"));	//写入短信2配置
		mv.addObject("msg","OK");
	...
	public ModelAndView saveSys2() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		Tools.writeFile(Const.FWATERM,pd.getString("isCheck1")+",cms,"+pd.getString("fcontent")+",cms,"+pd.getString("fontSize")+",cms,"+pd.getString("fontX")+",cms,"+pd.getString("fontY"));	//文字水印配置
		Tools.writeFile(Const.IWATERM,pd.getString("isCheck2")+",cms,"+pd.getString("imgUrl")+",cms,"+pd.getString("imgX")+",cms,"+pd.getString("imgY"));	//图片水印配置
		Watermark.fushValue();
		mv.addObject("msg","OK");
		mv.setViewName("save_result");
		return mv;
	...
	public ModelAndView saveSys3() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		Tools.writeFile(Const.WEBSOCKET,pd.getString("WIMIP")+",cms,"+pd.getString("WIMPORT")+",cms,"+pd.getString("OLIP")+",cms,"+pd.getString("OLPORT")+",cms,"+pd.getString("FHsmsSound"));	//websocket配置
		mv.addObject("msg","OK");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public ModelAndView saveSys4() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		Tools.writeFile(Const.LOGINEDIT,pd.getString("isZhuce")+",cms,"+pd.getString("isMusic"));	//登录页面配置
		mv.addObject("msg","OK");
		mv.setViewName("save_result");
		return mv;
	}
