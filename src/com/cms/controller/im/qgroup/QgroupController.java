package com.cms.controller.im.qgroup;
...
import com.cms.util.DelAllFile;
...
public class QgroupController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("im/qgroup/qgroup_list");
	...
	public ModelAndView goAdd()throws Exception{
		ModelAndView mv = this.getModelAndView();
		mv.setViewName("im/qgroup/qgroup_add");
		return mv;
	}
	...
	public ModelAndView goAddFromlist()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("im/qgroup/qgroup_edit");
	...
	public ModelAndView groupMembers(Page page) throws Exception{
		...
		mv.setViewName("im/qgroup/qgroup_members");
		mv.addObject("varList", varList);
		mv.addObject("pd", pd);
		mv.addObject("QX",Jurisdiction.getHC());							//按钮权限
		return mv;
