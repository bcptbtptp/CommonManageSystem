...
import com.cms.util.FileUpload;
import com.cms.util.PageData;
import com.cms.util.Jurisdiction;
import com.cms.util.PathUtil;
import com.cms.util.Tools;
import com.cms.plugin.websocketInstantMsg.ChatServerPool;
import com.cms.service.im.fgroup.FgroupManager;
import com.cms.service.im.friends.FriendsManager;
import com.cms.service.im.hismsg.HismsgManager;
import com.cms.service.im.imstate.ImstateManager;
import com.cms.service.im.iqgroup.IQgroupManager;
import com.cms.service.im.qgroup.QgroupManager;
import com.cms.service.im.sysmsg.SysmsgManager;
...
public class ImInterfaceController extends BaseController {
	...
	public List<PageData> getMyAllQgroup(PageData pd) throws Exception{
		...
		if(null == ipd){									//当我没有任何群时添加数据，否则修改
			...
			pd.put("item", ipd.getString("QGROUPS")+"'cms')");
		}
